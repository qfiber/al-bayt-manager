export const translations = {
  he: {
    ...
    writeOffBalanceConfirm: "האם אתה בטוח שברצונך למחוק את היתרה של ₪{balance} עבור דירה {apartment}? פעולה זו תאפס את היתרה לאפס.",
  ...
  ar: {
    ...
    writeOffBalanceConfirm: "هل أنت متأكد من شطب الرصيد ₪{balance} للشقة {apartment}؟ سيتم تصفير الرصيد.",
  ...
  en: {
    ...
    writeOffBalanceConfirm: "Are you sure you want to write off the balance of ₪{balance} for apartment {apartment}? This will reset the balance to zero.",
