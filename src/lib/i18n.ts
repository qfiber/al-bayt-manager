export const translations = {
  ar: {
    ...
    passwordTooWeak: 'كلمة المرور يجب أن تحتوي على 14+ حرف مع أحرف كبيرة وصغيرة وأرقام ورموز',
  ...
  en: {
    ...
    passwordTooWeak: 'Password must be 14+ characters with uppercase, lowercase, number, and special character',
