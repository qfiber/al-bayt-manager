        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) => setFormData({ ...formData, text_1: e.target.value })}
              rows={2}
            />
          </div>
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) => setFormData({ ...formData, text_2: e.target.value })}
              rows={2}
            />
          </div>
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) => setFormData({ ...formData, text_3: e.target.value })}
              rows={2}
            />
          </div>
